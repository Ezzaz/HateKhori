...
public class Navigation_Activity extends AppCompatActivity
    ...
    public final static String Message = "com.orionitinc.hatekhori.MESSAGE";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_scorecard) {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, "HateKhori");
            ...
            intent.setData(Uri.parse("mailto:"));
            String[] recipents = {"orionitbd@gmail.com"};
            intent.setType("message/rfc822");
            intent.putExtra(Intent.EXTRA_EMAIL, recipents);
            intent.putExtra(Intent.EXTRA_SUBJECT, "Hatekhori Reviews");
